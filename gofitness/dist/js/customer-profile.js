$(document).ready(function () {
  function initJssorSlider(elementId) {
    const jssor_SlideoTransitions = [
      [{b:-1,d:1,o:-0.7}],
    ...
    const jssor_slider = new $JssorSlider$(elementId, jssor_options);
    ...
    function ScaleSlider() {
      const containerElement = jssor_slider.$Elmt.parentNode;
